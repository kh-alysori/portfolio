        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-4 xl:pb-18 ">
          ...
          <div className=" text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br />
              <span className="text-accent">Khaleel Al-yasori</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">
              I excel at crafting elegant digital experiences and I proficient
            ...
            <div className="flex flex-col xl:flex-row items-center gap-8">
              ...
              <div className="mb-8 xl:mb-0 ">
                <Social
                  ...
                  iconStyle="w-9 h-9 border border-accent rounded-full flex justify-center items-center
