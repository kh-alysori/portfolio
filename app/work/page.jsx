...
const projects = [
  {
    ...
    title: "Project 1",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, veniam quas!",
                ...
                <Link href={project.live}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      ...
                      <TooltipContent className="bg-white text-black p-1 rounded-md">
                        <p> live project </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
                ...
                return (
                  <SwiperSlide key={index} className="w-full">
                    <div className="h-[460px] relative group flex justify-center items-center bg-pink-50/20">
                      ...
                      {/* image */}
                      <div className="w-full h-full relative roun">
                        <Image
                          src={project.image}
                          fill
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center rou nded-md transition-all"
              />
            </Swiper>
          </div>
        </div>
